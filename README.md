...
An end-to-end data engineering and business intelligence project designed to ingest, cleanse, and model global football transfer market data. This project implements a robust two-tier database architecture (Staging → Production) in MySQL, fully automated data schema profiling via Python, and advanced analytical views designed to extract deep historical player valuation, transfer trends, and managerial performance insights.
